    ...
    <div className='m-4'>
      ...
      <div className="row">
        <div className="col-lg-4 col-md-12">
          ...
          <p><a href="https://github.com/niklasertle/workout-tracker" target="_blank">GitHub</a> | <a href='https://whispering-citadel-87887.herokuapp.com/?id=61874958657a2a00162eb0c9' target="_blank">Deployed App</a></p>
          <h6>Technologoies</h6>
        ...
        <div className="col-lg-4 col-md-12">
          ...
          <p><a href="https://github.com/niklasertle/nje-ecommerce-backend" target="_blank">GitHub</a></p>
          <h6>Technologoies</h6>
